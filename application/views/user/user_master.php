  ...
  <div id="container">
    ...
    <aside id="sidebar">
		...
		<section id="login-details">
    		...
    		<h3>Logged in as</h3>
    		<h2><a class="user-button" href="javascript:void(0);"><?php echo $this->session->userdata('user_name');?>&nbsp;<span class="arrow-link-down"></span></a></h2>
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		<li><a href="<?php echo base_url();?>super_user/view_user_profile"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/chart.png">Profile</a></li>
                        <li>
	    			<a href="javascript:void(0);"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/clipboard-list.png">Purchase product</a>
	    			<ul class="sub">
	    				<li><a href="<?php echo base_url();?>super_user/view_product">View Product items to Purchase</a></li>
